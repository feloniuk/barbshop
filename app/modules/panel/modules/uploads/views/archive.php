        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <div class="widget-content widget-content-area br-6">
                ...
                <div class="flex-btw flex-vc mob_fc">
                    ...
                    <a class="btn btn-primary mb-2 mr-2" href="{URL:panel/uploads}">
                        <i class="fas fa-database"></i>
                        Active <span class="hide_block768">Files</span>
                    </a>
                </div>
                                        ...
                                        <div class="items-row align-items-center">
                                            <div class="dropdown dropup custom-dropdown-icon">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink-3">
                                                    ...
                                                    <a href="{URL:panel/uploads/resume/<?= $item->id ?>}" class="dropdown-item restore-item"><i class="fa fa-trash-restore"></i> Re-live</a>
                                                </div>
                                            </div>

                                            <div class="btns-list">
                                                <a href="{URL:panel/uploads/resume/<?= $item->id ?>}" class="btn-rectangle bs-tooltip fa fa-trash-restore restore-item" title="Re-live"></a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
