            ...
            <div class="statbox widget box box-shadow widget-top">
                <div class="widget-header">
                    ...
                    <div class="flex-btw flex-vc mob_fc">
                        ...
                        <?php if(!User::checkRole('moder')) { ?>
                            ...
                            <a class="btn btn-primary mb-2 mr-2" href="{URL:panel/shops/add}">
                                <i class="fas fa-plus"></i>
                                Add <span class="hide_block768">New Shops</span>
                            </a>
                            <?php } ?>
                        </div>
                    </div>
                ...
                <div class="table-responsive mb-4 mt-1" id="table-container">
                    ...
                    <table id="zero-config" class="table table-hover" style="width:100%">
                        ...
                        <tbody id="table-body">
                            <?php include _SYSDIR_ . 'modules/panel/modules/shops/views/_table_body.php' ?>
                        </tbody>
                    </table>
                    <div id="pagination-box">
                        <?php if ($this->list) {?>
                            <?= $this->count > $this->elemPerPage ? Pagination::panelPagination('panel/shops/pagination', ['orderby' => 'time', 'ordertype' => 'desc']) : '' ?>
                        <?php } else { ?>
                            <div class="mt-4">
...
<script>
    $(function () {
        let pagination = new Pagination('table-search', 'table-orderby', 'table-ordertype', 'shops', 'pagination');
