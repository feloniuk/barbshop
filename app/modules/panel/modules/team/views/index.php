                    ...
                    <div class="flex-btw flex-vc mob_fc">
                        ...
                        <div>
                            <a class="btn btn-primary mb-2 mr-2" href="{URL:panel/team/add}">
                                ...
                                Add <span class="hide_block768">New Member</span>
                            </a>
                        </div>
                        <?php } ?>
                    </div>
                    ...
                    <table id="zero-config" class="table table-hover" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th class="pointer sort-field">
                                    <span class="flex">Sort <span class="sort-arrows" data-sort="sort"><i class="fas fa-sort"></i></span></span>
                                </th>
                                <th class="pointer sort-field">
                                    <span class="flex">Full Name <span class="sort-arrows" data-sort="firstname"><i class="fas fa-sort"></i></span></span>
                                </th>
                                <th class="pointer sort-field">
                                    <span class="flex">Email <span class="sort-arrows" data-sort="email"><i class="fas fa-sort"></i></span></span>
                                </th>
                                <th class="pointer sort-field">
                                    <span class="flex">Role <span class="sort-arrows" data-sort="role"><i class="fas fa-sort"></i></span></span>
                                </th>
                                <?php if(!User::checkRole('moder')) { ?>
                                <th>Options</th>
                                <?php } ?>
                        ...
                        <tbody id="table-body">
                            <?php include _SYSDIR_ . 'modules/panel/modules/team/views/_table_body.php' ?>
                        </tbody>
                    </table>
                    <div id="pagination-box">
                        <?php if ($this->list) {?>
                            <?= $this->count > $this->elemPerPage ? Pagination::panelPagination('panel/team/pagination', ['orderby' => 'id', 'ordertype' => 'desc']) : '' ?>
                        <?php } else { ?>
                            <div class="mt-4">
...
<script>
    $(function () {
        let pagination = new Pagination('table-search', 'table-orderby', 'table-ordertype', 'team', 'pagination');
