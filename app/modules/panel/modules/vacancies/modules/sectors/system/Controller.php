...
class SectorsController extends Controller
{
    ...
    public function paginationAction()
    {
        ...
        Request::addResponse('html', '#table-body', $this->getView('modules/panel/modules/vacancies/modules/sectors/views/_table_body.php'));

        if ($totalRecordWithFilter > self::$numElement) {
            Request::addResponse('html', '#pagination-box', Pagination::panelPagination('panel/vacancies/sectors/pagination', allPost()));
        } else {
