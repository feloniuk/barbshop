<form id="form_box" action="{URL:panel/documents/edit/<?= $this->edit->id; ?>}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="items_group items_group-wrap">
                            <div class="items_left-side">
                                <div class="title-block">
                                    <a class="btn-ellipse bs-tooltip fas fa-rss" href="{URL:panel/documents}"></a>
                            ...
                            <div class="items_right-side">
                                ...
                                <a class="btn btn-outline-warning" href="{URL:panel/documents}"><i class="fas fa-reply"></i>Back</a>
                            </div>
                        </div>
                ...
                <div class="statbox widget box box-shadow">
                    <div class="widget-header widget-bottom">
                        ...
                        <a class="btn btn-success" onclick="
                                load('panel/documents/edit/<?= $this->edit->id; ?>', 'form:#form_box'); return false;">
