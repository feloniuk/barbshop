<form id="form_box" action="{URL:panel/services/edit/<?= $this->edit->id; ?>}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="items_group items_group-wrap">
                            <div class="items_left-side">
                                <div class="title-block">
                                    <a class="btn-ellipse bs-tooltip fas fa-rss" href="{URL:panel/services}"></a>
                            ...
                            <div class="items_right-side">
                                ...
                                <a class="btn btn-outline-warning" href="{URL:panel/services}"><i class="fas fa-reply"></i>Back</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control" name="price" id="price" value="<?= post('price', false, $this->edit->price); ?>">
                      </div>
                      <div class="form-group col-md-6">
                        <label for="service_time">Service Time</label>
                        <select class="form-control" name="service_time" id="service_time" required>
                          <option value="0.5" <?= checkOptionValue(post('service_time'), '0.5', $this->edit->service_time); ?>>30 min</option>
                          <option value="1" <?= checkOptionValue(post('service_time'), '1', $this->edit->service_time); ?>>1 hour</option>
                          <option value="1.5" <?= checkOptionValue(post('service_time'), '1.5', $this->edit->service_time); ?>>1 hour 30 min</option>
                          <option value="2" <?= checkOptionValue(post('service_time'), '2', $this->edit->service_time); ?>>2 hours</option>
                        </select>
                      </div>
                         <div class="form-group col-md-6">
                            <!-- Image -->
                            <?= ImageAlts::createField(
                                ...
                                $this->edit->image,
                                _SITEDIR_ . Storage::shardDir('services', $this->edit->id),
                ...
                <div class="statbox widget box box-shadow">
                    <div class="widget-header widget-bottom">
                        ...
                        <a class="btn btn-success" onclick="
                                setTextareaValue();
                                load('panel/services/edit/<?= $this->edit->id; ?>', 'form:#form_box'); return false;">
