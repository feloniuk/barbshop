<?php Popup::head("{$this->apply->name} Application", 'old-popup-styles full-height'); ?>
...
<form id="apply_form" class="popup-form">
    ...
    <?php } ?>
    <?php /* <a class="btn btn-outline-info" href="{URL:panel/vacancy_applications/edit/<?= $this->apply->id; ?>}">Edit</a> */ ?>
    ...
    <?php } else { ?>
        <a class="btn btn-outline-danger dlt_btn" href="{URL:panel/vacancy_applications/cv_delete/<?= $this->apply->id; ?>}">Delete</a>
    <?php } ?>
</form>
<?php Popup::foot(); ?>
